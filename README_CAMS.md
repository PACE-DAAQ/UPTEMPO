...
- `CAMS_GLOB_ANT_dir`: Directory containing original CAMS emissions data
...
species:
  ...
  - isoprene
  - monoterpenes
CAMS_GLOB_ANT_dir: '/path/to/CAMS_glob_ant/monthly/'
CAMS_grid_file: '/path/to/Gridinfo_CAMS-GLOB-ANT_c20240709.nc'
SERR_scrip_file: '/path/to/mpas_scrip.163842.nc'
Regridding_weights_file: '/path/to/ESMF_Weight_CAMSv5.1_grid_to_MPAS.x1.163842_c20250829.nc'
dst_file_format: '/path/to/output/CAMS-GLOB-ANT_{year}_MPAS.x1.163842.grid.SPC.nc'
inp_file_format: '/path/to/CAMS-GLOB-ANT_Glb_0.1x0.1_anthro_SPC_v5.3_monthly_{year}.nc'
sectors: []
```
