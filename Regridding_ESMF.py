    ...
    def __init__(self, var_array, fields=[], add_fields=[], dimension=[], dim_var={}, 
        ...
        if type(var_array) in [ xr.core.dataset.Dataset, xr.core.dataarray.DataArray ]:
            ...
            if 'time' in list( var_array.dims ):
                if type( var_array['time'].values[0] ) not in [cftime._cftime.DatetimeGregorian, cftime._cftime.DatetimeNoLeap]:
            ...
            ncol_check = 'ncol' in list(var_array.coords.keys())
            lat_check = 'lat' in list(var_array.coords.keys())
            lon_check = 'lon' in list(var_array.coords.keys())
